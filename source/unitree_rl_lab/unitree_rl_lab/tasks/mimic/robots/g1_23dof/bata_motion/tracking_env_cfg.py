...
class CommandsCfg:
    ...
    motion = mdp.MotionCommandCfg(
        asset_name="robot",
        # Bata motion file for 23dof
        motion_file=f"{os.path.dirname(__file__)}/bata_motion_23dof_60hz.npz",
...
class EventCfg:
    ...
    base_com = EventTerm(
        ...
        params={
            ...
            "com_range": {"x": (-0.02, 0.02), "y": (-0.03, 0.03), "z": (-0.03, 0.03)},
        },
    )

    # interval - gentler pushes for ceremonial motion
...
class RewardsCfg:
    ...
    # -- tracking (higher weights for smooth ceremonial motion)
...
class TerminationsCfg:
    ...
    anchor_ori = DoneTerm(
        ...
        params={"asset_cfg": SceneEntityCfg("robot"), "command_name": "motion", "threshold": 0.7},
    )
